...
<head>
    ...
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/feather/feather.css')}}">
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/ti-icons/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/css/vendor.bundle.base.css')}}">
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/datatables.net-bs4/dataTables.bootstrap4.css')}}">
    <link rel="stylesheet" href="{{asset('admin_asset/vendor/ti-icons/css/themify-icons.css')}}">
...
<script src="{{asset('admin_asset/vendor/js/vendor.bundle.base.js')}}"></script>
<script src="{{asset('admin_asset/vendor/chart.js/Chart.min.js')}}"></script>
<script src="{{asset('admin_asset/vendor/datatables.net/jquery.dataTables.js')}}"></script>
<script src="{{asset('admin_asset/vendor/datatables.net-bs4/dataTables.bootstrap4.js')}}"></script>
...
<script src="{{asset('admin_asset/js/file-upload.js')}}"></script>
<script src="{{asset('admin_asset/js/typeahead.js')}}"></script>
<script src="{{asset('admin_asset/js/select2.js')}}"></script>
@yield('script')
